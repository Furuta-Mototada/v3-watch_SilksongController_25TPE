...
- **Date:** 2025-10-17 13:06:31
- **Duration:** 600.0s (10.0 minutes)
- **Sensor Data Points:** 86237
- **Audio Duration:** 599.5s
...
```bash
cd ../../src
python align_voice_labels.py --session 20251017_125600_session --whisper ../data/continuous/20251017_125600_session/audio_16k.json
```
